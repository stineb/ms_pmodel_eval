...
\begin{figure}[!ht]
    \centering
%\includegraphics[width=0.48\textwidth]{fig/modobs_anomalies_daily_FULL.pdf}
%\includegraphics[width=0.48\textwidth]{fig/modobs_anomalies_xdaily_FULL.pdf}\\
