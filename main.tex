...
%\begin{equation}
   V_{\mathrm{cmax25}} = V_{\mathrm{cmax}} \; \exp\Bigg(\frac{\Delta H_{\mathrm{Vcmax}}}{R}\Big( \frac{1}{T_{K,0}} - \frac{1}{T_K} \Big)\Bigg)
%\end{equation}
%with $\Delta H_{\mathrm{Vcmax}}=65330$ J mol$^{-1}$, $R = 8.3145$ J mol$^{-1}$ K$^{-1}$, $T_K$ is the ambient temperature in Kelvin, and $T_{K,0}$ is 25$^{\circ}$C in Kelvin (298.15 K).
...
%\begin{equation}
   R_{\mathrm{d}} = R_{\mathrm{d25}} \Bigg( \exp\Bigg(\frac{\Delta H_{\mathrm{Rd}}}{R}\Big( \frac{1}{T_{K,0}} - \frac{1}{T_K} \Big)\Bigg) \Bigg)^{-1}
%\end{equation}
