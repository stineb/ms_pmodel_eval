...
The evaluation of functional relationships reveals a fundamental difference between observational GPP data based on different flux decomposition methods and its response to temperatures below 15$^{\circ}$C
